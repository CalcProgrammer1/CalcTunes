...
public class ContentLibraryDatabaseAdapter extends BaseAdapter
{
    private Context con;
    ...
    public ContentLibraryDatabaseAdapter (Context context, SQLiteDatabase data, String dbquery)
    {
        con = context;
        db = data;
        query = dbquery;
        
        if( (con != null) && (db != null) && (query != null) )
        {
